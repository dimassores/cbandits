#!/usr/bin/env python3
"""
Simple example demonstrating how to use UCB-B2 algorithm
for budget-constrained multi-armed bandits with unknown variances.
"""
...
def simple_ucb_b2_test():
    """
    A simple test of UCB-B2 algorithm with 3 arms.
    UCB-B2 is designed for uncorrelated cost and reward distributions
    with unknown second-order moments.
    """
    print("=== Simple UCB-B2 Test ===\n")
    
    # Step 1: Define the arms (bandit machines)
    # Each arm has a cost and reward distribution
    # Note: UCB-B2 assumes uncorrelated cost and reward (cov_XR = 0.0)
    arm_configs = [
        {
            "name": "Arm 1 (Best)",
    ...
    # Step 2: Define UCB-B2 algorithm parameters
    algorithm_params = {
